...
public class ApplicationLoaderImpl extends ApplicationLoader {
    ...
    protected void startAppCenterInternal(Activity context) {
        if (org.verdgram.messenger.BuildConfig.DEBUG) {
            return;
        }
        try {
            if (BuildVars.DEBUG_VERSION) {
                ...
                crashlytics.setCustomKey("version", getVersionName(org.verdgram.messenger.BuildConfig.VERSION_NUM));
            ...
            if (BuildVars.DEBUG_VERSION) {
                ...
                String appHash = org.verdgram.messenger.BuildConfig.APP_CENTER_HASH;
...
//        }
    ...
    public boolean isCustomUpdate() {
        return !TextUtils.isEmpty(org.verdgram.messenger.BuildConfig.BETA_URL);
    }
